...
void Library::browseCatalog() {
	...
	cout << "Debug printing:\n\t4. Pre-order print w/ debug\n\t2. In-order print w/ debug\n\t3. Post-order print w/ debug" << endl;
	cin >> choice;
	switch(choice) {
		case 1:
			tree->printTreePre(false);
			break;
		case 2:
			tree->printTreeIO(false);
			break;
		case 3:
			tree->printTreePost(false);
			break;
		case 4:
			tree->printTreePre(true);
			break;
		case 5:
			tree->printTreeIO(true);
			break;
		case 6:
			tree->printTreePost(true);
			break;
		default:
